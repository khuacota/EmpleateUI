...
@Component({
  selector: 'app-show-complete-information-employee',
  templateUrl: './show-complete-information-employee.component.html',
  styleUrls: ['./show-complete-information-employee.component.css']
})
export class ShowCompleteInformationEmployeeComponent implements AfterViewInit {
